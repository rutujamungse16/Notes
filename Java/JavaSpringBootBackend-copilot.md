...
18. **What is `@RestController`?**  
    **Answer:** Combines `@Controller` and `@ResponseBody` to create REST endpoints returning JSON/XML.
...
## Final notes
- This Markdown file contains **120** focused questions and answers across the full backend stack, with **coding examples** and **SQL snippets** you can practice.  
- When answering in interviews, **reference your projects** (migration utilities, PostgreSQL optimizations, AWS S3 integrations, JUnit/Mockito testing) and quantify impact (performance gains, zero-defect releases, automation benefits).

---

If you want, I can:
- Provide this as a downloadable `.md` file split into topic-specific practice sets, or  
- Generate **timed mock tests** or **flashcards** from these questions.